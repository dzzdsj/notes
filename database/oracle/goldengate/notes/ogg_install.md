...
vi /ogg/dirprm/eshog201.prm

```
EXTRACT eshog201
SETENV (NLS_LANG=AMERICAN_AMERICA.AL32UTF8)
userid ogg@db2,password AADAAAAAAAAAAADARDAIDCLGYBRHGAXCYIIFZIPEXGBCTDMCAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA ,AES128, ENCRYPTKEY oggkey
--FLUSHCSECS 10
--EOFDELAYCSECS 10
BR BRINTERVAL 20M
--TRANLOGOPTIONS INTEGRATEDPARAMS (MAX_SGA_SIZE 2048, PARALLELISM 2)
TRANLOGOPTIONS CHECKPOINTRETENTIONTIME 1
--TRANLOGOPTIONS ASYNCTRANSPROCESSING 1024
TRANLOGOPTIONS EXCLUDETAG 0001
REPORTCOUNT EVERY 1 MINUTE,RATE
EXTTRAIL ./dirdat/la
DISCARDFILE ./dirrpt/eshog201.dsc, APPEND, MEGABYTES 1024
CACHEMGR CACHESIZE 1024MB, CACHEDIRECTORY ./dirtmp
TABLE dzzdsj.t_test,
GETBEFORECOLS (
ON UPDATE ALL,
...
vi /ogg/dirprm/pshog201.prm

```
EXTRACT pshog201
SETENV (NLS_LANG=AMERICAN_AMERICA.AL32UTF8)
PASSTHRU
RMTHOST db1,compress,MGRPORT 7809,TCPBUFSIZE 1000000, TCPFLUSHBYTES 1000000
RMTTRAIL ./dirdat/ra
REPORTCOUNT EVERY 1 MINUTE, RATE
DISCARDFILE ./dirrpt/pshog001.dsc, APPEND, MEGABYTES 1024
TABLE dzzdsj.t_test;
```

vi /ogg/dirprm/rshog001.prm

```
REPLICAT rshog001
userid ogg@db2,password AADAAAAAAAAAAADARDAIDCLGYBRHGAXCYIIFZIPEXGBCTDMCAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA ,AES128, ENCRYPTKEY oggkey
DBOPTIONS SETTAG 0001
--DBOPTIONS ENABLE_INSTANTIATION_FILTERING
REPORTCOUNT EVERY 1 MINUTE, RATE
BATCHSQL BATCHESPERQUEUE 100,OPSPERBATCH 2000, BATCHTRANSOPS 1000
REPERROR (DEFAULT, DISCARD)
DISCARDFILE ./dirrpt/rshog001.dsc, APPEND, MEGABYTES 1024
CACHEMGR CACHESIZE 1024MB, CACHEDIRECTORY ./dirtmp
MAP dzzdsj.t_test, TARGET dzzdsj.t_test,
COMPARECOLS (ON UPDATE ALL, ON DELETE ALL),
...
```
ggsci
dblogin userid ogg@db2,password AADAAAAAAAAAAADARDAIDCLGYBRHGAXCYIIFZIPEXGBCTDMCAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA,AES128,ENCRYPTKEY oggkey
add checkpointtable ogg.ogg_checkpoint
ADD TRANDATA dzzdsj.t_test allcols PREPARECSN
REGISTER EXTRACT eshog201 database
ADD EXTRACT eshog201, INTEGRATED TRANLOG, BEGIN NOW 
ADD EXTTRAIL ./dirdat/la, EXTRACT eshog201
ADD EXTRACT pshog201, EXTTRAILSOURCE ./dirdat/la, BEGIN NOW
ADD RMTTRAIL ./dirdat/ra, EXTRACT pshog201
REGISTER REPLICAT rshog001 database
ADD REPLICAT rshog001, INTEGRATED EXTTRAIL ./dirdat/ra, checkpointtable ogg.ogg_checkpoint
ADD HEARTBEATTABLE
```
...
ggsci
dblogin userid ogg@db1,password AADAAAAAAAAAAADARDAIDCLGYBRHGAXCYIIFZIPEXGBCTDMCAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA,AES128,ENCRYPTKEY oggkey
DELETE TRANDATA dzzdsj.t_test allcols
DELETE EXTTRAIL ./dirdat/la
DELETE EXTRACT efzog001
UNREGISTER EXTRACT efzog001 database
DELETE RMTTRAIL ./dirdat/ra
DELETE EXTRACT pfzog001
DELETE REPLICAT rfzog201
delete heartbeattable
delete checkpointtable ogg.ogg_checkpoint
```
...
DELETE TRANDATA dzzdsj.t_test allcols
DELETE EXTTRAIL ./dirdat/la
DELETE EXTRACT eshog201
UNREGISTER EXTRACT eshog201 database
DELETE RMTTRAIL ./dirdat/ra
DELETE EXTRACT pshog201
DELETE REPLICAT rshog001
delete heartbeattable
delete checkpointtable ogg.ogg_checkpoint
```
