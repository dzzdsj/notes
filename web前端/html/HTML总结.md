...
| 标签（推荐使用后者）       | 显示效果              |
| -------------------------- | --------------------- |
| <b></b>或<strong></strong> | <strong>粗体</strong> |
| <i></i>或<em></em>         | <em>斜体</em>         |
| <s></s>或<del></del>       | <del>删除线</del>     |
| <u></u>或 <ins></ins>      | <ins>下划线</ins>     |
...
| alt    | 文本   | 图像不能显示时的替换文本         |
| title  | 文本   | 鼠标悬停时显示的内容             |
| width  | 像素   | 图像宽度，xhtml不支持%页面百分比 |
| height | 像素   | 图像高度，xhtml不支持%页面百分比 |
| border | 数字   | 图像边框的宽度                   |
...
| 属性名      | 含义                                 | 常用属性值          |
| ----------- | ------------------------------------ | ------------------- |
| border      | 表格的边框，默认无                   | 像素值              |
| cellspacing | 单元格与单元格边框之间的空白间距     | 像素值              |
| cellpadding | 单元格内容与单元格边框之间的空白间距 | 像素值              |
| width       | 表格的宽度                           | 像素值              |
| height      | 表格的高度                           | 像素值              |
...
|      | ie9  | firefox3.5 | opera10.5 | chrome | safari3.0 |
| ---- | ---- | ---------- | --------- | ------ | --------- |
| ogg  |      | ok         | ok        | ok     |           |
| mp3  | ok   |            |           | ok     | ok        |
| wav  |      | ok         | ok        |        | ok        |
...
<audio controls>
	<!--通过source标签指定多格式音频文件>
	<audio src="./xx.mp3"></audio>
	<audio src="./xx.ogg"></audio>
	<audio src="./xx.wav"></audio>
	您的浏览器不支持html音频播放功能
</audio>
 ```
...
**多浏览器支持的方案类似上面音频方案，通过source标签指定多格式视频文件
