...
```
border 盒子（容器）的边框大小（边框）
padding 内容与内边框的大小（内边距）
margin 盒子间，外边框的距离（外边距）
```

<img src="image/box.png"  width="700" />

<img src="image/box.gif"  width="700" />
...
<img src="image/嵌套块元素垂直外边距的合并.png" />
...
```
   ...
   <img src="image/one.jpg" width="500" /> 
...
```
  ...
  <img src="image/two.jpg" width="400" />
...
<img src="image/一列固定宽度且居中.jpg" width="400" />

最普通的，最为常用的结构

## 两列左窄右宽型

<img src="image/两列左窄右宽型.jpg" width="400" />

## 通栏平均分布型

<img src="image/通栏平均分布型.jpg" width="600" />
...
<img src="image/正常标准流盒子.jpg" />

<img src="image/子盒子浮动.jpg" />
...
菜单栏、选项栏、工具栏、浮动面板（拖拽名称，可单独操作面板）、绘图窗口窗口菜单，可显示隐藏所有面板
...
3. 利用标尺   基于参考线的切片 （选择切片工具）
   ...
   ![1498466734205](media/基于参考线的切片 .png)
